  ...
  return (
    <div className="sticky top-0 z-20 flex h-16 items-center bg-[#1a1a1a] px-6">
      ...
      <div className="flex items-center gap-8">
        ...
        <a href="/library" className="text-gray-300 hover:text-green-400 transition-colors">
          Library
        </a>
        
        <a href="/reviews" className="text-gray-300 hover:text-green-400 transition-colors">
          Reviews
        </a>
